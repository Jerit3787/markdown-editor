...
import { mermaidThemeFor, mermaidCodeRenderer, renderMermaidDiagrams, type MermaidLike } from "../../../client/src/mermaid-preview";
...
describe("renderMermaidDiagrams", () => {
  ...
  it("initializes mermaid with the given theme and replaces the placeholder with rendered SVG", async () => {
    ...
    expect(mermaid.initialize).toHaveBeenCalledWith({ theme: "dark", startOnLoad: false, htmlLabels: false, securityLevel: "strict" });
